...
import com.example.chatapp.Fragments.ImageMessageFragment;
...
public class RecyclerListMessageAdapter extends RecyclerView.Adapter<RecyclerListMessageAdapter.ViewHolder>  {
    ...
    public RecyclerListMessageAdapter(List<Message> listMessages, Context context, int rMessageMine, int rMessageFriend,
        ...
        this.rImageMessageFriend = rImageMessageFriend;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView imageViewMessageMine,imageView_pdf_MessageMine, imageViewMessageFriend,imageView_pdf_MessageFriend;
        ...
        public ViewHolder(View itemView) {
            ...
            //imageView_pdf_MessageMine=itemView.findViewById(R.id.imageView_pdf_MessageMine);
            //imageView_pdf_MessageFriend=itemView.findViewById(R.id.imageView_pdf_MessageFriend);
...
//        View viewImagePdfMine = LayoutInflater.from(parent.getContext()).inflate(rImagePdfMine, parent, false);
        // tạo view tin nhắn hình của bạn
      //  View viewImagePdfFriend = LayoutInflater.from(parent.getContext()).inflate(rImagePdfFriend, parent, false);
...
//            }
    ...
    public void getImageStorage(final ImageView imageView, String senderUid, String receiverUid, String nameImage) {
       Glide.with(context)
                .load(nameImage)
               .apply(new RequestOptions().override(600, 1000))
                .fitCenter()
             .into(imageView);
