        ...
        switch (v.getId()) {
            case R.id.buttonEditPassWord:
                ...
                if(renewpassword.length()<6)
                    Toast.makeText(this, "New password must be at least 6 characters long!", Toast.LENGTH_LONG).show();
                ...
                if (messageAfterDecrypt != "" && user != null) {
                    ...
                    if (!oldpassword.equals(getoldpassword)) {
                        Toast.makeText(this, "The current password is incorrect, please check it again!", Toast.LENGTH_LONG).show();
                        break;
                    }
                    if (newpassword.equals(renewpassword)) {
                        ...
                        Toast.makeText(this, "The new password you entered is incorrect, please check it again!", Toast.LENGTH_LONG).show();
                        break;
                    }
                    break;
                }
