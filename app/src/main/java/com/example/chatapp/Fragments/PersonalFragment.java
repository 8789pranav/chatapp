        ...
        if (bitmap != null) {
            ...
            uploadTask.addOnFailureListener(new OnFailureListener() {
                ...
                public void onFailure(@NonNull Exception exception) {
                    Toast.makeText(getActivity(), "Did not receive the picture please check again !!", Toast.LENGTH_LONG).show();
                }
            ...
            uploadTask.addOnFailureListener(new OnFailureListener() {
                ...
                public void onFailure(@NonNull Exception exception) {
                    Toast.makeText(getActivity(),
                            "Did not receive the picture please check again !!", Toast.LENGTH_LONG).show();
                }
            }).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                @Override
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
        ...
        try {
            ...
            ref.getFile(localFile).addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                ...
                public void onSuccess(FileDownloadTask.TaskSnapshot taskSnapshot) {
                    ...
                    if (isNotify)
                        Toast.makeText(getActivity(),
                                "Change avatar successfully", Toast.LENGTH_SHORT).show();
                ...
                public void onFailure(@NonNull Exception exception) {
                    if (isNotify)
                        Toast.makeText(getActivity(), "Change avatar Failed", Toast.LENGTH_SHORT).show();
                }
        ...
        try {
            ...
            ref.getFile(localFile).addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                ...
                public void onSuccess(FileDownloadTask.TaskSnapshot taskSnapshot) {
                    ...
                    if (isNotify)
                        Toast.makeText(getActivity(), "Change wallpaper successfully", Toast.LENGTH_SHORT).show();
                }
            }).addOnFailureListener(new OnFailureListener() {
                @Override
                public void onFailure(@NonNull Exception exception) {
    ...
    public void deleteAvatar() {
        ...
        desertRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(getActivity(), "Change avatar successfully", Toast.LENGTH_SHORT).show();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception exception) {
    ...
    public void deleteBackground() {
        ...
        desertRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(getActivity(),
                        "Change wallpaper successfully", Toast.LENGTH_SHORT).show();
                // File deleted successfully
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception exception) {
                ...
                Toast.makeText(getActivity(),
                        "Change wallpaper Failed", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
